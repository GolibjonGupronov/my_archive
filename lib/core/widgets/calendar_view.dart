                          ...
                          children: <Widget>[
                            Expanded(
                              child: Column(
                                ...
                                children: <Widget>[
                                  TextView("Dan", textAlign: TextAlign.left),
                                  4.height,
                                  TextView(startDate != null ? DateFormat('dd/MM/yy').format(startDate!) : '--/--/-- '),
                                ],
                              ),
                            ),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: <Widget>[
                                  TextView("Gacha"),
                                  4.height,
                                  TextView(endDate != null ? DateFormat('dd/MM/yy').format(endDate!) : '--/--/-- '),
                                ],
                              ),
                            )
                          ],
