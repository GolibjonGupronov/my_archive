...
import 'package:my_archive/features/edit_profile/data/data_sources/edit_profile_data_source_impl.dart';
...
void initEditProfileInjection() {
  sl.registerSingleton<EditProfileDataSource>(FirebaseEditProfileDataSourceImpl(firestore: sl(), secureStorage: sl()));
